...
const data = {
   ...
   Text: [
      `Я создаю решения, где идея — не просто вдохновение, а отправная точка для результата. Запускаю проекты,
         управляю командой, веду переговоры и внедряю новое. Работаю с командами, управляю процессами, выстраиваю стратегию и веду переговоры.`,
